...
export function App() {
  ...
  const [companyCrew, setCompanyCrew] = useState<CrewMember[]>([
    ...
    { id: 'c201', name: 'Capt. Alexander Wright', role: 'Master / Captain', department: 'master', email: 'a.wright@mozukmarine.com', phoneNumber: '+1 416 555 0192', nationality: 'Canadian', signOnDate: '10/02/2026', seamanBookNo: 'SB-993012', assignedShipId: 'ship-2', assignedShipName: 'EVER GIVEN' },
    { id: 'c203', name: 'Carlos Mendez', role: 'Chief Officer', department: 'deck', email: 'c.mendez@mozukmarine.com', phoneNumber: '+63 917 555 8899', nationality: 'Filipino', signOnDate: '15/03/2026', assignedShipId: 'ship-2', assignedShipName: 'EVER GIVEN' },
    { id: 'c204', name: 'Li Wei', role: 'Second Officer', department: 'deck', email: 'l.wei@mozukmarine.com', phoneNumber: '+86 138 0000 1122', nationality: 'Chinese', signOnDate: '01/04/2026', assignedShipId: 'ship-2', assignedShipName: 'EVER GIVEN' },
    { id: 'c202', name: 'Hiroshi Tanaka', role: 'Chief Engineer', department: 'engine', email: 'h.tanaka@mozukmarine.com', phoneNumber: '+81 90 9988 7766', nationality: 'Japanese', signOnDate: '01/03/2026', assignedShipId: 'ship-2', assignedShipName: 'EVER GIVEN' },
    { id: 'c205', name: 'Lars Hansen', role: 'Second Engineer', department: 'engine', email: 'l.hansen@mozukmarine.com', phoneNumber: '+45 20 12 34 56', nationality: 'Danish', signOnDate: '20/03/2026', assignedShipId: 'ship-2', assignedShipName: 'EVER GIVEN' },
    { id: 'c206', name: 'Francois Dubois', role: 'Chief Cook', department: 'kitchen', email: 'f.dubois@mozukmarine.com', phoneNumber: '+33 6 12 34 56 78', nationality: 'French', signOnDate: '25/02/2026', assignedShipId: 'ship-2', assignedShipName: 'EVER GIVEN' },
    { id: 'c207', name: 'Pedro Gomez', role: 'Messman', department: 'kitchen', email: 'p.gomez@mozukmarine.com', phoneNumber: '+63 915 444 3322', nationality: 'Filipino', signOnDate: '10/03/2026', assignedShipId: 'ship-2', assignedShipName: 'EVER GIVEN' },

    { id: 'c301', name: 'Capt. Jean-Luc Picard', role: 'Master / Captain', department: 'master', email: 'jl.picard@mozukmarine.com', phoneNumber: '+33 1 42 68 55 00', nationality: 'French', signOnDate: '20/01/2026', seamanBookNo: 'SB-170100', assignedShipId: 'ship-3', assignedShipName: 'MSC OSCAR' },
    { id: 'c303', name: 'William Riker', role: 'Chief Officer', department: 'deck', email: 'w.riker@mozukmarine.com', phoneNumber: '+1 212 555 0177', nationality: 'American', signOnDate: '01/02/2026', assignedShipId: 'ship-3', assignedShipName: 'MSC OSCAR' },
    { id: 'c302', name: 'Sven Lindqvist', role: 'Chief Engineer', department: 'engine', email: 's.lindqvist@mozukmarine.com', phoneNumber: '+46 8 123 4567', nationality: 'Swedish', signOnDate: '15/02/2026', assignedShipId: 'ship-3', assignedShipName: 'MSC OSCAR' },
    { id: 'c304', name: 'Geordi La Forge', role: 'Electro-Technical Officer (ETO)', department: 'engine', email: 'g.laforge@mozukmarine.com', phoneNumber: '+1 312 555 0144', nationality: 'American', signOnDate: '20/02/2026', assignedShipId: 'ship-3', assignedShipName: 'MSC OSCAR' },
    { id: 'c305', name: 'Neelix', role: 'Chief Cook', department: 'kitchen', email: 'neelix@mozukmarine.com', phoneNumber: '+1 800 555 0199', nationality: 'Talaxian', signOnDate: '05/03/2026', assignedShipId: 'ship-3', assignedShipName: 'MSC OSCAR' },

    { id: 'c401', name: 'Capt. Joao Silva', role: 'Master / Captain', department: 'master', email: 'j.silva@mozukmarine.com', phoneNumber: '+258 84 123 4567', nationality: 'Mozambican', signOnDate: '10/01/2026', seamanBookNo: 'SB-MZ-0019', assignedShipId: 'ship-4', assignedShipName: 'MOZUK MARINER' },
    { id: 'c403', name: 'Antonio Cossa', role: 'Chief Officer', department: 'deck', email: 'a.cossa@mozukmarine.com', phoneNumber: '+258 82 987 6543', nationality: 'Mozambican', signOnDate: '01/02/2026', assignedShipId: 'ship-4', assignedShipName: 'MOZUK MARINER' },
    { id: 'c402', name: 'Mateus Nhampossa', role: 'Chief Engineer', department: 'engine', email: 'm.nhampossa@mozukmarine.com', phoneNumber: '+258 84 555 1212', nationality: 'Mozambican', signOnDate: '12/01/2026', assignedShipId: 'ship-4', assignedShipName: 'MOZUK MARINER' },
    { id: 'c404', name: 'Inacio Tembe', role: 'Chief Cook', department: 'kitchen', email: 'i.tembe@mozukmarine.com', phoneNumber: '+258 87 333 4444', nationality: 'Mozambican', signOnDate: '25/01/2026', assignedShipId: 'ship-4', assignedShipName: 'MOZUK MARINER' },
  ]);
