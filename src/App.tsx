...
export function App() {
  ...
  const [companyCrew, setCompanyCrew] = useState<CrewMember[]>([
    ...
    { id: 'c1', name: 'Capt. Marcus Vance', role: 'Master / Captain', department: 'master', nationality: 'British', dateOfBirth: '14/05/1975', passportNumber: 'GB-99482019', passportExpiry: '12/10/2030', seamanBookNo: 'SB-882109', seamanBookExpiry: '15/06/2028', signOnDate: '15/01/2026', signOnLocation: 'Rotterdam', assignedShipId: 'ship-1', assignedShipName: 'SIRIOS BULK II', vesselHistory: [{ shipName: 'SIRIOS BULK II', role: 'Master / Captain', startDate: '15/01/2026' }, { shipName: 'SIRIOS BULK II', role: 'Master / Captain', startDate: '15/01/2024', endDate: '30/08/2025' }, { shipName: 'MOZUK MARINER', role: 'Chief Officer', startDate: '10/02/2022', endDate: '15/11/2023' }] },
    { id: 'c3', name: 'Alexey Ivanov', role: 'Chief Officer', department: 'deck', nationality: 'Ukrainian', dateOfBirth: '22/08/1984', passportNumber: 'UA-7710294', passportExpiry: '18/04/2029', seamanBookNo: 'SB-UA-55201', seamanBookExpiry: '20/09/2027', signOnDate: '10/03/2026', signOnLocation: 'Antwerp', assignedShipId: 'ship-1', assignedShipName: 'SIRIOS BULK II', vesselHistory: [{ shipName: 'SIRIOS BULK II', role: 'Chief Officer', startDate: '10/03/2026' }, { shipName: 'MOZUK MARINER', role: 'Second Officer', startDate: '05/05/2023', endDate: '10/12/2024' }] },
    { id: 'c5', name: 'Kenji Sato', role: 'Second Officer', department: 'deck', nationality: 'Japanese', dateOfBirth: '03/11/1990', passportNumber: 'JP-4491028', passportExpiry: '30/11/2031', seamanBookNo: 'SB-JP-99201', seamanBookExpiry: '10/01/2028', signOnDate: '12/05/2026', signOnLocation: 'Yokohama', assignedShipId: 'ship-1', assignedShipName: 'SIRIOS BULK II', vesselHistory: [{ shipName: 'SIRIOS BULK II', role: 'Second Officer', startDate: '12/05/2026' }, { shipName: 'EVER GIVEN', role: 'Third Officer', startDate: '15/01/2024', endDate: '20/12/2024' }] },
    { id: 'c6', name: 'Thomas Miller', role: 'Bosun', department: 'deck', nationality: 'Filipino', dateOfBirth: '18/06/1982', passportNumber: 'PH-3392810', passportExpiry: '05/07/2028', seamanBookNo: 'SB-PH-11029', seamanBookExpiry: '12/12/2027', signOnDate: '01/04/2026', signOnLocation: 'Manila', assignedShipId: 'ship-1', assignedShipName: 'SIRIOS BULK II', vesselHistory: [{ shipName: 'SIRIOS BULK II', role: 'Bosun', startDate: '01/04/2026' }, { shipName: 'MOZUK MARINER', role: 'Able Seaman', startDate: '01/03/2021', endDate: '15/02/2023' }] },
    { id: 'c7', name: 'Jose Santos', role: 'Able Seaman', department: 'deck', nationality: 'Filipino', dateOfBirth: '09/09/1995', passportNumber: 'PH-8829104', passportExpiry: '14/02/2030', seamanBookNo: 'SB-PH-77291', seamanBookExpiry: '08/08/2029', signOnDate: '15/04/2026', signOnLocation: 'Manila', assignedShipId: 'ship-1', assignedShipName: 'SIRIOS BULK II', vesselHistory: [{ shipName: 'SIRIOS BULK II', role: 'Able Seaman', startDate: '15/04/2026' }, { shipName: 'SIRIOS BULK II', role: 'Ordinary Seaman', startDate: '10/05/2024', endDate: '20/12/2024' }] },
    { id: 'c2', name: 'Dimitrios Pappas', role: 'Chief Engineer', department: 'engine', nationality: 'Greek', dateOfBirth: '07/03/1978', passportNumber: 'GR-1102938', passportExpiry: '25/09/2029', seamanBookNo: 'SB-GR-44910', seamanBookExpiry: '18/11/2027', signOnDate: '01/02/2026', signOnLocation: 'Piraeus', assignedShipId: 'ship-1', assignedShipName: 'SIRIOS BULK II', vesselHistory: [{ shipName: 'SIRIOS BULK II', role: 'Chief Engineer', startDate: '01/02/2026' }, { shipName: 'SIRIOS BULK II', role: 'Chief Engineer', startDate: '01/02/2024', endDate: '15/12/2024' }, { shipName: 'MSC OSCAR', role: 'Second Engineer', startDate: '01/06/2021', endDate: '10/01/2023' }] },
    { id: 'c4', name: 'Elena Rostova', role: 'Second Engineer', department: 'engine', nationality: 'Estonian', dateOfBirth: '15/12/1988', passportNumber: 'EE-5592810', passportExpiry: '10/03/2032', seamanBookNo: 'SB-EE-33821', seamanBookExpiry: '05/05/2028', signOnDate: '05/04/2026', signOnLocation: 'Tallinn', assignedShipId: 'ship-1', assignedShipName: 'SIRIOS BULK II', vesselHistory: [{ shipName: 'SIRIOS BULK II', role: 'Second Engineer', startDate: '05/04/2026' }, { shipName: 'SIRIOS BULK II', role: 'Third Engineer', startDate: '10/01/2023', endDate: '20/11/2024' }] },
    { id: 'c8', name: 'Viktor Morozov', role: 'Third Engineer', department: 'engine', nationality: 'Latvian', dateOfBirth: '29/01/1992', passportNumber: 'LV-7739102', passportExpiry: '16/08/2030', seamanBookNo: 'SB-LV-88192', seamanBookExpiry: '19/02/2028', signOnDate: '01/05/2026', signOnLocation: 'Riga', assignedShipId: 'ship-1', assignedShipName: 'SIRIOS BULK II', vesselHistory: [{ shipName: 'SIRIOS BULK II', role: 'Third Engineer', startDate: '01/05/2026' }, { shipName: 'SIRIOS BULK II', role: 'Fourth Engineer', startDate: '15/04/2024', endDate: '10/01/2025' }] },
    { id: 'c9', name: 'Ahmed Hassan', role: 'Oiler / Motorman', department: 'engine', nationality: 'Egyptian', dateOfBirth: '11/04/1994', passportNumber: 'EG-3301928', passportExpiry: '22/01/2029', seamanBookNo: 'SB-EG-55102', seamanBookExpiry: '14/04/2027', signOnDate: '20/05/2026', signOnLocation: 'Alexandria', assignedShipId: 'ship-1', assignedShipName: 'SIRIOS BULK II', vesselHistory: [{ shipName: 'SIRIOS BULK II', role: 'Oiler / Motorman', startDate: '20/05/2026' }, { shipName: 'MOZUK MARINER', role: 'Wiper', startDate: '05/02/2023', endDate: '30/11/2024' }] },
    { id: 'c10', name: 'Giuseppe Rossi', role: 'Chief Cook', department: 'kitchen', nationality: 'Italian', dateOfBirth: '05/07/1980', passportNumber: 'IT-9920194', passportExpiry: '11/11/2031', seamanBookNo: 'SB-IT-22910', seamanBookExpiry: '01/09/2028', signOnDate: '15/02/2026', signOnLocation: 'Genoa', assignedShipId: 'ship-1', assignedShipName: 'SIRIOS BULK II', vesselHistory: [{ shipName: 'SIRIOS BULK II', role: 'Chief Cook', startDate: '15/02/2026' }, { shipName: 'MSC OSCAR', role: 'Second Cook', startDate: '10/03/2022', endDate: '15/01/2024' }] },
    { id: 'c11', name: 'Manny Pacquiao', role: 'Messman / Steward', department: 'kitchen', nationality: 'Filipino', dateOfBirth: '17/12/1996', passportNumber: 'PH-4401928', passportExpiry: '28/02/2030', seamanBookNo: 'SB-PH-99210', seamanBookExpiry: '15/10/2029', signOnDate: '01/03/2026', signOnLocation: 'Manila', assignedShipId: 'ship-1', assignedShipName: 'SIRIOS BULK II', vesselHistory: [{ shipName: 'SIRIOS BULK II', role: 'Messman / Steward', startDate: '01/03/2026' }] },

    { id: 'c201', name: 'Capt. Alexander Wright', role: 'Master / Captain', department: 'master', nationality: 'Canadian', signOnDate: '10/02/2026', seamanBookNo: 'SB-993012', assignedShipId: 'ship-2', assignedShipName: 'EVER GIVEN' },
    { id: 'c203', name: 'Carlos Mendez', role: 'Chief Officer', department: 'deck', nationality: 'Filipino', signOnDate: '15/03/2026', assignedShipId: 'ship-2', assignedShipName: 'EVER GIVEN' },
    { id: 'c204', name: 'Li Wei', role: 'Second Officer', department: 'deck', nationality: 'Chinese', signOnDate: '01/04/2026', assignedShipId: 'ship-2', assignedShipName: 'EVER GIVEN' },
    { id: 'c202', name: 'Hiroshi Tanaka', role: 'Chief Engineer', department: 'engine', nationality: 'Japanese', signOnDate: '01/03/2026', assignedShipId: 'ship-2', assignedShipName: 'EVER GIVEN' },
    { id: 'c205', name: 'Lars Hansen', role: 'Second Engineer', department: 'engine', nationality: 'Danish', signOnDate: '20/03/2026', assignedShipId: 'ship-2', assignedShipName: 'EVER GIVEN' },
    { id: 'c206', name: 'Francois Dubois', role: 'Chief Cook', department: 'kitchen', nationality: 'French', signOnDate: '25/02/2026', assignedShipId: 'ship-2', assignedShipName: 'EVER GIVEN' },
    { id: 'c207', name: 'Pedro Gomez', role: 'Messman', department: 'kitchen', nationality: 'Filipino', signOnDate: '10/03/2026', assignedShipId: 'ship-2', assignedShipName: 'EVER GIVEN' },

    { id: 'c301', name: 'Capt. Jean-Luc Picard', role: 'Master / Captain', department: 'master', nationality: 'French', signOnDate: '20/01/2026', seamanBookNo: 'SB-170100', assignedShipId: 'ship-3', assignedShipName: 'MSC OSCAR' },
    { id: 'c303', name: 'William Riker', role: 'Chief Officer', department: 'deck', nationality: 'American', signOnDate: '01/02/2026', assignedShipId: 'ship-3', assignedShipName: 'MSC OSCAR' },
    { id: 'c302', name: 'Sven Lindqvist', role: 'Chief Engineer', department: 'engine', nationality: 'Swedish', signOnDate: '15/02/2026', assignedShipId: 'ship-3', assignedShipName: 'MSC OSCAR' },
    { id: 'c304', name: 'Geordi La Forge', role: 'Electro-Technical Officer (ETO)', department: 'engine', nationality: 'American', signOnDate: '20/02/2026', assignedShipId: 'ship-3', assignedShipName: 'MSC OSCAR' },
    { id: 'c305', name: 'Neelix', role: 'Chief Cook', department: 'kitchen', nationality: 'Talaxian', signOnDate: '05/03/2026', assignedShipId: 'ship-3', assignedShipName: 'MSC OSCAR' },

    { id: 'c401', name: 'Capt. Joao Silva', role: 'Master / Captain', department: 'master', nationality: 'Mozambican', signOnDate: '10/01/2026', seamanBookNo: 'SB-MZ-0019', assignedShipId: 'ship-4', assignedShipName: 'MOZUK MARINER' },
    { id: 'c403', name: 'Antonio Cossa', role: 'Chief Officer', department: 'deck', nationality: 'Mozambican', signOnDate: '01/02/2026', assignedShipId: 'ship-4', assignedShipName: 'MOZUK MARINER' },
    { id: 'c402', name: 'Mateus Nhampossa', role: 'Chief Engineer', department: 'engine', nationality: 'Mozambican', signOnDate: '12/01/2026', assignedShipId: 'ship-4', assignedShipName: 'MOZUK MARINER' },
    { id: 'c404', name: 'Inacio Tembe', role: 'Chief Cook', department: 'kitchen', nationality: 'Mozambican', signOnDate: '25/01/2026', assignedShipId: 'ship-4', assignedShipName: 'MOZUK MARINER' },
  ]);
