  ...
  const [ships, setShips] = useState<Ship[]>([
    {
      ...
      addedAt: '21/09/2026',
      crew: [
        { id: 'c1', name: 'Capt. Marcus Vance', role: 'Master / Captain', department: 'master', nationality: 'British', signOnDate: '15/01/2026', seamanBookNo: 'SB-882109' },
        { id: 'c3', name: 'Alexey Ivanov', role: 'Chief Officer', department: 'deck', nationality: 'Ukrainian', signOnDate: '10/03/2026' },
        { id: 'c5', name: 'Kenji Sato', role: 'Second Officer', department: 'deck', nationality: 'Japanese', signOnDate: '12/05/2026' },
        { id: 'c6', name: 'Thomas Miller', role: 'Bosun', department: 'deck', nationality: 'Filipino', signOnDate: '01/04/2026' },
        { id: 'c7', name: 'Jose Santos', role: 'Able Seaman', department: 'deck', nationality: 'Filipino', signOnDate: '15/04/2026' },
        { id: 'c2', name: 'Dimitrios Pappas', role: 'Chief Engineer', department: 'engine', nationality: 'Greek', signOnDate: '01/02/2026' },
        { id: 'c4', name: 'Elena Rostova', role: 'Second Engineer', department: 'engine', nationality: 'Estonian', signOnDate: '05/04/2026' },
        { id: 'c8', name: 'Viktor Morozov', role: 'Third Engineer', department: 'engine', nationality: 'Latvian', signOnDate: '01/05/2026' },
        { id: 'c9', name: 'Ahmed Hassan', role: 'Oiler / Motorman', department: 'engine', nationality: 'Egyptian', signOnDate: '20/05/2026' },
        { id: 'c10', name: 'Giuseppe Rossi', role: 'Chief Cook', department: 'kitchen', nationality: 'Italian', signOnDate: '15/02/2026' },
        { id: 'c11', name: 'Manny Pacquiao', role: 'Messman / Steward', department: 'kitchen', nationality: 'Filipino', signOnDate: '01/03/2026' },
      ],
      documents: [
